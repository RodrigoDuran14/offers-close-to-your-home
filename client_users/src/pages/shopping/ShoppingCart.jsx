...
export default function ShoppingCart() {
  ...
  const handlerPago = async () => {
    const response = await fetch('https://justoffers-back.up.railway.app/buy-products', {
      method: 'POST',
      headers: {
  ...
  const handlerDetalleVenta = async () => {
    ...
    await axios.post("https://justoffers-back.up.railway.app/venta", venta)
      .then(response => {
    ...
    await axios.put("https://justoffers-back.up.railway.app/products", stockActualizado)
    .then(response => {
      console.log(response.data);
